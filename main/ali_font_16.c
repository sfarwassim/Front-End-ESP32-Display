 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font /root/hmi_esp32/hmi/aliph.ttf -r 0x20-0x7F --symbols ° --size 16 --format lvgl --bpp 4 --no-compress -o ali_font_16.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3864, .adv_w = 93, .box_w = 6, .box_h = 7, .ofs_x = 0, .ofs_y = 5}
};
